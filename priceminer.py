...
if __name__ == '__main__':
    ...
    items = ['Copo de vidro Nadir', 'Pen Drive 64gb',
    ...
    produtos.to_html("/home/matheus/Scripts/tabela_produtos.html")
    pesquisa_preco.browser.close()

    email_from = "kronenautobots@gmail.com"
    email_to = "mtsilva2303@gmail.com"
    smtp = "smtp.gmail.com"
    excel_file = "/home/matheus/Scripts/tabela_produtos.html"
    msg = EmailMessage()
    ...
    server.starttls()
    server.login(email_from, open(
        '/home/matheus/Scripts/senha.txt').read().strip())
